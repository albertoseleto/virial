...
m1='H'#input('qual átomo será usado na primeira massa?')
m2='H'#input('qual átomo será usado na segunda massa?')
...
st.subheader('This is some text.')
st.header('This is some text.')
